...
Contributors: janthielemann
Donate link: www.janthielemann.de/donate
Tags: divi, divi sensei, divi-sensei, addon, addons, add-ons, divi extras, divi plugin, divi module, divi modules, extra, elegantthemes, elegant, themes, elegant themes, module, modules
Requires at least: 4.5.0
Tested up to: 5.2.2
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

A useful collection of Divi Modules and extensions.
...
The second purpose is that our modules can be used inside [The Loop](https://codex.wordpress.org/The_Loop) to build completely customized archives. A great plugin which works perfectly together with Battle Suit for Divi is [Toolset](https://divi-sensei.com/toolset). Together with our Toolset Add-On, your imagination becomes the only limit for building layouts and utilising custom post fields.
...
There are paid add-ons though, which have a very specialised purpose. For example, we have a add-on which adds [Toolset](https://divi-sensei.com/toolset) related modules and we are working on other add-ons as well. 
...
= 1.12.0 =
* Improved Video Lightbox module to accept youtub.be URLs
